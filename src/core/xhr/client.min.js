/**
 * This XHR client object designed to work with Amazon API Gateway and Cognito Auth services
 *
 * By default all request are treated as 'application/json' type. For Cross Origin Resource Sharing
 * the 'Allow' header is set a with wildcard scope.
 *
 */
(function xhrClientScope(global) {
    ...
    global.XHRClient = function() {
        ...
        function validateHttpMethod(method) {
            if (_allowedMethods.indexOf(method) < 0) {
                throw "Invalid HTTP Method: use " + _allowedMethods.join(", ");
            }
            return method;
        }
        ...
        _clientManager.makeRequest = function(request, completeCallback) {
            ...
            if (_requestHandler == null) {
                throw "Missing XHR request handler, define; xhrClient.setRequestHandler( jQuery.ajax )";
            }
         ...
         * @param {string} token, Sets the header 'Authorization' with a pre-defined token hash.
